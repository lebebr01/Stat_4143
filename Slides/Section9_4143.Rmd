...
# Example  2
- A team statistician for the University of Iowa wants to estimate the average number of points the team will score during the season. The population mean is unknown, but the estimated standard deviation is 5 points. A random sample of 24 games was selected from the past two seasons; the average number of points scored was 27.4.
...
where $\bar{X}$ is the sample mean,  
$\mu$ is the population mean (given),  
$s$ is the sample standard deviation (given),  
$n$ is the sample size. 
